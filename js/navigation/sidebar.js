...
<div class="flex max-h-page bg-[#181818] p-2">
  <aside class="w-[240px] text-white rounded-2xl flex flex-col p-4 space-y-6 min-h-[1300px] max-h-[90vh] overflow-y-hidden">
    ...
    <nav class="flex flex-col space-y-4">
      ...
      <!-- Home -->
      <a href="/home.html" class="flex items-center gap-6 text-gray-300 hover:text-blue-400 transition-colors text-xl">
      ...
      <!-- My Projects -->
      <a href="/project-list.html" class="flex items-center gap-6 text-gray-300 hover:text-blue-400 transition-colors text-xl">
        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div>
        ...
        <div id="inventory-menu" class="flex flex-col ml-14 mt-2 space-y-2 hidden text-gray-300 text-lg">
          <a href="/inventory.html" class="hover:text-blue-400">All Equipment</a>
      ...
      <!-- Calendar -->
      <a href="/calendar.html" class="flex items-center gap-6 text-gray-300 hover:text-blue-400 transition-colors text-xl">
        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div>
        ...
        <div id="customers-menu" class="flex flex-col ml-14 mt-2 space-y-2 hidden text-gray-300 text-lg">
          <a href="/customers.html" class="hover:text-blue-400">All Customers</a>
          <a href="/customer-profile.html" class="hover:text-blue-400">All Contacts</a>
        </div>
      </div>
      ...
      <!-- Data -->
      <a href="/template.html" class="flex items-center gap-6 text-gray-300 hover:text-blue-400 transition-colors text-xl">
        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
        </svg>
        Data
    ...
    <a href="/home.html" class="flex items-center gap-6 text-yellow-400 hover:text-yellow-300 font-semibold transition-colors text-xl mb-2">
      <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="/login.html" class="flex items-center gap-6 text-red-400 hover:text-red-300 font-semibold transition-colors text-xl">
      <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
